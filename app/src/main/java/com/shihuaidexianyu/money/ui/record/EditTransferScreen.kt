            ...
            item {
                Card(modifier = Modifier.fillMaxWidth()) {
                    Column(modifier = Modifier.padding(20.dp), verticalArrangement = Arrangement.spacedBy(12.dp)) {
                        Text("编辑转账", style = MaterialTheme.typography.headlineSmall)
                        ...
                        OutlinedTextField(state.note, viewModel::updateNote, label = { Text("备注") }, modifier = Modifier.fillMaxWidth(), singleLine = true)
